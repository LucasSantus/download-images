<h1 align="center">Download Images</h1>
...
> Este projeto foi desenvolvido com intuito de facilitar downloads de imagens.

A ideia é:

_"Criar um script que pegaria links de imagens na internet e os baixaria de forma simples e rápida."_
...
```
git clone git@github.com:LucasSantus/download-images.git
...
Este projeto está licenciado sob a Licença MIT License - veja o [LICENSE.md](https://github.com/LucasSantus/download-images/blob/master/LICENSE) para melhores detalhes.
